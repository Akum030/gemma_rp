"""
Batch MCAT Inference — Transformers Model
==========================================
Reads : 76cat_queries  (header: query)
Output: transformers_mcat_results.csv  (keyword, mcat_name, mcat_id)

Run:
  python batch_inference_transformers.py
"""
...
OUTPUT_CSV     = "transformers_mcat_results.csv"
# Model is in the same directory as this script
MODEL_DIR      = str(Path(__file__).resolve().parent / "mcat-gemma2-9b-finetuned")
