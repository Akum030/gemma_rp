...
KEY_CANON = {
    # product / part type synonyms
    "product_type": "part type", "product type": "part type", "type": "part type",
    "part_type": "part type", "device_type": "part type", "device type": "part type",
    "item_type": "part type", "component": "part type", "product": "part type",
    "motor part type": "part type", "motor": "part type", "motors": "part type",
    "actuator": "part type", "actuators": "part type",
    # brand synonyms
    ...
    "product number": "model name/number", "model_name/number": "model name/number",
    "model number/code": "model name/number", "serial_number": "model name/number",
    "product code": "model name/number", "motor model": "model name/number",
    "motor name/number": "model name/number", "servo motor model": "model name/number",
    "encoder model": "model name/number",
    # power synonyms
    ...
    # RPM / speed — GT uses "rpm"
    "speed": "rpm", "rated_speed": "rpm", "rotation_speed": "rpm",
    "full load rpm": "rpm", "rated speed": "rpm", "ratedspeed": "rpm",
    # driven type — GT uses "driven type"
    ...
    "voltage_rating": "voltage", "operating voltage": "voltage",
    "voltage_type": "voltage",
    # starter type
    "starter_type": "starter type", "motor_starter_type": "starter type",
    "starting type": "starter type",
    # usage/application
    "application": "usage",
    # feature
    "features": "feature",
